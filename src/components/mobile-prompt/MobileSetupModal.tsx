  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running McCarthy OS, then sign in.',
    ...
    },
    {
      ...
      body: 'McCarthy OS can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open McCarthy OS on your phone',
      body:
