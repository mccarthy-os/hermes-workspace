...
export const tourSteps: Array<Step> = [
  ...
  // Step 8: Terminal
  {
    ...
    content:
      'Built-in terminal for quick commands. Execute shell commands without leaving McCarthy OS.',
  },
  ...
  // Step 10: Settings
  {
    ...
    content:
      'Configure providers, themes, accent colors, and more. Make McCarthy OS yours.',
  },
  // Step 11: Finish
  {
    target: 'body',
    ...
    content:
      'Start chatting with your AI, explore the tools, and customize McCarthy OS to fit your workflow. Need help? Press ? to see all keyboard shortcuts.',
  },
]
