...
export const SwarmRuntimeSchema = z.object({
  ...
  lastRealSummary: z.string().nullable(),
  lastRealResult: z.string().nullable(),
...
export function normalizeSwarmRuntime(
  ...
  const runtime = {
    ...
    lastRealSummary: readString(raw.lastRealSummary),
    lastRealResult: readString(raw.lastRealResult),
